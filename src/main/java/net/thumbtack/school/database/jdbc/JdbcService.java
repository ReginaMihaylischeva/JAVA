...
public class JdbcService {
    ...
    public static Trainee getTraineeByIdUsingColNames(int traineeId) throws SQLException {
        String getTraineeByIdUsingColNamesQuery = "SELECT id,firstname, lastname, rating FROM trainee WHERE Id=?";
        try (PreparedStatement stmt = JdbcUtils.getConnection().prepareStatement(getTraineeByIdUsingColNamesQuery)) {
    ...
    public static List<Trainee> getTraineesUsingColNames() throws SQLException {
        ...
        try (PreparedStatement stmt = JdbcUtils.getConnection().prepareStatement(getTraineeByIdUsingColNamesQuery); ResultSet rs = stmt.executeQuery(getTraineeByIdUsingColNamesQuery)) {
    ...
    public static Subject getSubjectByIdUsingColNames(int subjectId) throws SQLException {
        String getSubjectByIdUsingColNames = "SELECT id,name FROM subject WHERE Id=?";
