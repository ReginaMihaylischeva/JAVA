...
public class Triangle {
    ...
    public boolean isInside(int x, int y){
      if ( ((x-point1.getX())*(point1.getY()-point2.getY())-(point1.getX()-point2.getX())*(y-point1.getY())>0 &
    ...
    public boolean isInside(Point2D point){
        if ( ((point.getX()-point1.getX())*(point1.getY()-point2.getY())-(point1.getX()-point2.getX())*(point.getY()-point1.getY())>0 &
