...
public class TestTriangle {
    ...
    @Test
    public void testTriangle1() throws ColorException {
        Point2D point1 = new Point2D(3, 1);
        Point2D point2 = new Point2D(0, 1);
        Point2D point3 = new Point2D(1, 3);
        Triangle triangle = new Triangle(point1, point2, point3, Color.GREEN);
        assertEquals(3, triangle.getPoint1().getX());
        assertEquals(1, triangle.getPoint1().getY());
        assertEquals(0, triangle.getPoint2().getX());
        assertEquals(1, triangle.getPoint2().getY());
        assertEquals(1, triangle.getPoint3().getX());
        assertEquals(3, triangle.getPoint3().getY());
        assertEquals(Color.GREEN, triangle.getColor());
    }


    @Test
    public void testTriangle2() throws ColorException {
        Point2D point1 = new Point2D(3, 1);
        Point2D point2 = new Point2D(0, 1);
        Point2D point3 = new Point2D(1, 3);
        Triangle triangle = new Triangle(point1, point2, point3, "GREEN");
        assertEquals(3, triangle.getPoint1().getX());
        assertEquals(1, triangle.getPoint1().getY());
        assertEquals(0, triangle.getPoint2().getX());
        assertEquals(1, triangle.getPoint2().getY());
