...
public class TestRectangle {
    ...
    @Test
    public void testRectangle1() throws ColorException {
        Point2D topLeft = new Point2D(5, 8);
        Point2D bottomRight = new Point2D(15, 22);
        Rectangle rect = new Rectangle(topLeft, bottomRight, Color.GREEN);
        rect.setTopLeft( new Point2D (3,5));
        rect.setBottomRight( new Point2D (13,25));
        assertEquals(3, rect.getTopLeft().getX());
        assertEquals(5, rect.getTopLeft().getY());
        assertEquals(13, rect.getBottomRight().getX());
        assertEquals(25, rect.getBottomRight().getY());
        assertEquals(rect.getLength(), 10);
        assertEquals(rect.getWidth(), 20);
        assertEquals(Color.GREEN, rect.getColor());
    }

    @Test
    public void testRectangle2() throws ColorException {
        Point2D topLeft = new Point2D(5, 8);
        Point2D bottomRight = new Point2D(15, 22);
        Rectangle rect = new Rectangle(topLeft, bottomRight, "GREEN");
        rect.setTopLeft( new Point2D (3,5));
        rect.setBottomRight( new Point2D (13,25));
        assertEquals(3, rect.getTopLeft().getX());
        assertEquals(5, rect.getTopLeft().getY());
    ...
    public void testRectangle1A() throws ColorException {
        ...
        assertEquals(rect.getLength(), 20);
        assertEquals(rect.getWidth(), 20);
