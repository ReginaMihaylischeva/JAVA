...
public class TestCylinder {
    ...
    @Test
    public void testCylinder1() throws ColorException {
        Point2D center = new Point2D(17, 39);
        Cylinder cylinder = new Cylinder(center, 4, 6, Color.RED);
        assertEquals(17, cylinder.getCenter().getX());
        assertEquals(39, cylinder.getCenter().getY());
        assertEquals(4, cylinder.getRadius());
        assertEquals(6, cylinder.getHeight());
        assertEquals(Color.RED, cylinder.getColor());
    }

    @Test
    public void testCylinder2() throws ColorException {
        Point2D center = new Point2D(17, 39);
        Cylinder cylinder = new Cylinder(center, 4, 6, "RED");
        assertEquals(17, cylinder.getCenter().getX());
        assertEquals(39, cylinder.getCenter().getY());
        assertEquals(4, cylinder.getRadius());
        assertEquals(6, cylinder.getHeight());
    ...
    public void testSetHeight() throws ColorException {
        Cylinder cylinder = new Cylinder(5,4, 4, 6, "RED");
