...
public class TestRectangle3D {
    ...
    @Test
    public void testIsPointInsideRectangle3D3() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 20, Color.RED);
        assertTrue(rect3D.isInside(20, 30,10));
        assertTrue(rect3D.isInside(10, 30,5));
        assertTrue(rect3D.isInside(30, 30,7));
        assertTrue(rect3D.isInside(10, 40,10));
        assertFalse(rect3D.isInside(0, 0,4));
        assertFalse(rect3D.isInside(10, 100,4));
        assertFalse(rect3D.isInside(-10, 20,4));
        assertFalse(rect3D.isInside(10, -20,4));
        assertFalse(rect3D.isInside(20, 30,30));
    }

    @Test
    public void testIsPointInsideRectangle3D24() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 20, Color.RED);
        assertTrue(rect3D.isInside(new Point3D(20, 30,10)));
        assertTrue(rect3D.isInside(new Point3D(10, 30,15)));
        assertTrue(rect3D.isInside(new Point3D(30, 30,7)));
        assertTrue(rect3D.isInside(new Point3D(10, 40,10)));
        assertFalse(rect3D.isInside(new Point3D(0, 0,4)));
        assertFalse(rect3D.isInside(new Point3D(10, 100,14)));
        assertFalse(rect3D.isInside(new Point3D(-10, 20,12)));
        assertFalse(rect3D.isInside(new Point3D(10, -20,17)));
        assertFalse(rect3D.isInside(new Point3D(20, 30,30)));
    }
    ...
    @Test
    public void testRectangle3D1() throws ColorException {
        Point2D topLeft = new Point2D(5, 8);
        Point2D bottomRight = new Point2D(15, 22);
        Rectangle3D rect3D = new Rectangle3D(topLeft, bottomRight, 13, Color.GREEN);
        rect3D.setTopLeft( new Point2D (3,5));
        rect3D.setBottomRight( new Point2D (13,25));
        rect3D.setHeight(5);
        assertEquals(3, rect3D.getTopLeft().getX());
        assertEquals(5, rect3D.getTopLeft().getY());
        assertEquals(13, rect3D.getBottomRight().getX());
        assertEquals(25, rect3D.getBottomRight().getY());
        assertEquals(rect3D.getLength(), 10);
        assertEquals(rect3D.getWidth(), 20);
        assertEquals(rect3D.getHeight(), 5);
        assertEquals(Color.GREEN, rect3D.getColor());
    }
    @Test
    public void testRectangle3D2() throws ColorException {
        Point2D topLeft = new Point2D(5, 8);
        Point2D bottomRight = new Point2D(15, 22);
        Rectangle3D rect3D = new Rectangle3D(topLeft, bottomRight, 13, "GREEN");
        rect3D.setTopLeft( new Point2D (3,5));
        rect3D.setBottomRight( new Point2D (13,25));
        rect3D.setHeight(5);
        assertEquals(3, rect3D.getTopLeft().getX());
    ...
    public void testRectangle3D1A() throws ColorException {
        ...
        assertEquals(rect3D.getLength(), 20);
        assertEquals(rect3D.getWidth(), 20);
        assertEquals(rect3D.getHeight(), 10);
    ...
    public void testRectangle3D2A() throws ColorException {
        ...
        assertEquals(30, rect3D.getBottomRight().getX());
        assertEquals(40, rect3D.getBottomRight().getY());
        assertEquals(20, rect3D.getLength(), 20);
        assertEquals(20, rect3D.getWidth(), 20);
        assertEquals(rect3D.getHeight(), 10);
        assertEquals(Color.BLUE, rect3D.getColor());
    }
    ...
    public void testRectangle3D4A() throws ColorException {
        ...
        assertEquals(rect3D.getHeight(), 1);
        assertEquals(Color.BLUE, rect3D.getColor());
    }
